...
@permission_required('costa_rica.view_costarica', raise_exception=True)
def listar_costa_rica(request):
    ...
    formularios = {registro.id: CostaRicaForm(instance=registro) for registro in page_obj}
...
@login_required(login_url='/login/')
@permission_required('costa_rica.add_costarica', raise_exception=True)
...
@login_required(login_url='/login/')
@permission_required('costa_rica.change_costarica', raise_exception=True)
...
@login_required(login_url='/login/')
@permission_required('costa_rica.delete_costarica', raise_exception=True)
